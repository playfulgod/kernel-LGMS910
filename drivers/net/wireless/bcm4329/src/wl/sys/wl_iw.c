...
#if 0  /* 20110818 cheolsook.lee@lge.com, move to wl_iw_set_priv() for MS910 [START] */
/* 20110728 cheolsook.lee@lge.com [Wi-Fi] to succeed DHCP procedure after wakeup [START] */
/* 20110728 cheolsook.lee@lge.com [Wi-Fi] to succeed DHCP procedure after wakeup [START] */
#if defined(CONFIG_BRCM_LGE_WL_ARPOFFLOAD)
		do 
		{ 
...
/* 20110728 cheolsook.lee@lge.com [Wi-Fi] to succeed DHCP procedure after wakeup [END] */
#endif  /* 20110818 cheolsook.lee@lge.com, move to wl_iw_set_priv() for MS910 [START] */
