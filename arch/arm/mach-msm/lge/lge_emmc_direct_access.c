...
#ifdef CONFIG_MACH_LGE_BRYCE_VS910
#define MMC_XCALBACKUP_TYPE		0x6E
#define MMC_PERSIST_EXT3_TYPE		0x75
#define MMC_CACHE_EXT3_TYPE		0x76
#define MMC_SYSTEM_EXT3_TYPE		0x78
#define MMC_USERDATA_EXT3_TYPE	0x79
#else if (CONFIG_MACH_LGE_BRYCE_MS910)
...
#if defined (CONFIG_MACH_LGE_BRYCE_VS910)
static char *ext3_partitions[] = {"system", "userdata", "cache", "NONE"};
#elif defined (CONFIG_MACH_LGE_BRYCE_MS910)
static char *ext3_partitions[] = {"persist", "cache", "system", "userdata", "NONE"};
#endif
